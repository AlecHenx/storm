...
package org.apache.storm.starter.mapmatch;
...
public class OfflineMapMatcherTest {
    ...
    public void testMapMatching() {
        ...
        expected.add(new SequenceState<>(rp11, gps1, (RoadPath) null, null));
        expected.add(new SequenceState<>(rp21, gps2, new RoadPath(rp11, rp21), null));
        expected.add(new SequenceState<>(rp31, gps3, new RoadPath(rp21, rp31), null));
        expected.add(new SequenceState<>(rp41, gps4, new RoadPath(rp31, rp41), null));
