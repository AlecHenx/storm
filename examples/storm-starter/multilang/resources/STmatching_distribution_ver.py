...
def network_data():
    nx_vertice = pd.read_csv('/home/hch/EATsys/preprocess/example_data/tdrive/road/node.csv',
                             usecols=['node', 'lng', 'lat'])
    vertice_dict = nx_vertice.set_index('node').T.to_dict('list')

    nx_edge = pd.read_csv('/home/hch/EATsys/preprocess/example_data/tdrive/road/edge.csv',
                          usecols=['edge', 's_node', 'e_node', 's_lng', 's_lat', 'e_lng', 'e_lat', 'c_lng', 'c_lat'])
    edge_dict = nx_edge.set_index('edge').T.to_dict('list')

    rdnetwork = pd.read_csv('/home/hch/EATsys/preprocess/example_data/tdrive/road/edge_weight.csv',
